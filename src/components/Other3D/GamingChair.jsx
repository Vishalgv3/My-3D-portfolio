...
export function GamingChair(props) {
    const { nodes, materials } = useGLTF('3D/models/objects/Gaming_chair.glb')
    return (
        <group {...props} dispose={null}>
            <group position={[0, 0, -16.14]} rotation={[-Math.PI / 2, 0, 0]} scale={0.193}>
...
useGLTF.preload('3D/models/objects/Gaming_chair.glb')